...
#emptyEmails = emptyEmails.loc[0:500]
...
def enter_linkedIn_profiles_from_baserow(pLink):
    ...
    driver = uc.Chrome(options=chrome_options, seleniumwire_options=options, driver_executable_path='./chromedriver.exe')
    driver.maximize_window()
    driver.get("https://www.linkedin.com/")
    time.sleep(2)
    driver.add_cookie({"name": "li_at", "value": "AQEDATk0dXwCg3RjAAABj5jHGLMAAAGPvNOcs00AAVtH-EaQ1phC3E4qiPJHXl9OP5r3z4T2G_bAKZTz8BSKprkLw97OdOq65ylgz7ZiQR6NDuNgC5g2AvrbWdW_-cObe-z1oGTyhEvm6d_G7wc1unx8"})
    ...
    time.sleep(0.3)
    kUser.send_keys(lk_credentials["kEmail"])
    time.sleep(0.2)
    ...
    kPword.send_keys(lk_credentials["kPassword"])
    kBtn = driver.find_element(By.TAG_NAME, "button")
    time.sleep(0.3)
    kBtn.click()
    time.sleep(3)
